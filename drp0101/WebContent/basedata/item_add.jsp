...
<body class="body1">
<form name="itemForm" target="_self" id="itemForm" action="basedata/ItemController"  method="post" onsubmit="return validateItem()">
...
<table width="95%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td><select name="category" class="select1" id="category">
			<c:forEach items="${itemCategory }" var="ic">
	...
	<tr>
		...
		<td><select name="unit" class="select1" id="unit">
			<c:forEach items="${itemUnit }" var="iu">
...
<hr width="97%" align="center" size=0>
<div align="center"><input name="btnAdd" class="button1" type="submit" id="btnAdd" value="添加"> &nbsp;&nbsp;&nbsp;&nbsp; <input name="btnBack" class="button1" type="button" id="btnBack"
	value="返回" onClick="history.go(-1)"></div>
</div>
</form>
</body>
</html>
