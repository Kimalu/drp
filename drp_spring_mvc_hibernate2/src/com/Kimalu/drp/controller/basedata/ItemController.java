...
//			modelMap.addAttribute("queryItemName", "");
	...
	public String addItem(Item item, int category, int unit) throws Exception {
		item.setItemCategory((ItemCategory) dataDictService
				.getDataDict(category));
	...
	public String doModify(Item item, int categoryId, int unitId) {
		item.setItemCategory((ItemCategory) dataDictService
				.getDataDict(categoryId));
	...
	public String showUploadPic4Item(int id, ModelMap modelMap) {
		Item item = itemService.getItem(id);
		modelMap.addAttribute("item", item);
	...
	public String doUploadPic4Item(int id, @RequestParam("file")  MultipartFile file,HttpServletRequest request,ModelMap modelMap) throws IOException {
		Item item = itemService.getItem(id);
