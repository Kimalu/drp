...
<html>
	...
	<body class="body1">
		<form name="itemForm" target="_self" id="itemForm" action="servlet/basedata/ModifyItemServlet" method="post" onsubmit="return validateForm()">
			<div align="center">
				...
				<div align="center">
					...
					<input name="btnModify" class="button1" type="button"
						id="btnModify" value="返回" onClick="location='<%=basePath %>servlet/basedata/SearchItemServlet'">
				</div>
			</div>
		</form>
	</body>
