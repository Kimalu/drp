...
<table width="95%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="23%" align="left">
			<input name="clientId" type="text" class="text1" id="clientId" size="12" maxlength="10" readonly="true"> 
			<input name="btnSelectClient" type="button" id="btnSelectClient" value="..." class="button1" onClick="window.open('<%=basePath%>flowcard/client_select.jsp', '选择分销商', 'width=700, height=400, scrollbars=no')">
		</td>
		<td width="14%">
			<div align="right">供方分销商名称:&nbsp;</div>
		</td>
		<td width="37%" align="left">
			<input name="clientName" type="text" class="text1" id="clientName" size="40" maxlength="40" readonly="true">
		</td>
		<td width="11%">
			<input name="btnQuery" type="button" class="button1" id="btnQuery" value="查询" onClick="queryFlowCard()">
		</td>
	</tr>
	<tr>
		<td height="26">
		...
		<td align="left">
			<input id="beginDate" type="text" name="beginDate" size="10" maxlength="10" readonly="true">
		</td>
		<td>
			<div align="right">结束日期:&nbsp;</div>
		</td>
		<td align="left">
			<input id="endDate" type="text" name="endDate" size="10" maxlength="10" readonly="true">
		</td>
