...
<html>
	...
	function addItem() {
		...
		window.location="<%=basePath %>servlet/basedata/ShowAddItemServlet";
	}
	...
	function modifyItem() {
		...
		window.self.location = "<%=basePath %>servlet/basedata/ShowModifyItemServlet?itemNo=" + selectFlags[index].value;
	}
	...
	function searchItem() {
		with(document.forms[0]) {
			action="<%=basePath %>servlet/basedata/SearchItemServlet";
			method="post";
			submit();
		}
	}
	...
	function topPage() {
		window.location = "<%=basePath %>servlet/basedata/SearchItemServlet?pageNo=${pageModel.topPageNo}&clientIdOrName=${param.clientIdOrName}";
	}
	
	function previousPage() {
		window.location = "<%=basePath %>servlet/basedata/SearchItemServlet?pageNo=${pageModel.previousPageNo}&clientIdOrName=${param.clientIdOrName}";
	}
	
	function nextPage() {
		window.location = "<%=basePath %>servlet/basedata/SearchItemServlet?pageNo=${pageModel.nextPageNo}&clientIdOrName=${param.clientIdOrName}";
	}
	
	function bottomPage() {
		window.location = "<%=basePath %>servlet/basedata/SearchItemServlet?pageNo=${pageModel.buttomPageNo}&clientIdOrName=${param.clientIdOrName}";
	}
	...
	function uploadPic4Item() {
		...
		window.self.location = "<%=basePath %>servlet/basedata/ShowItemUploadServlet?itemNo=" + selectFlags[index].value;
	}
</script>
	</head>
