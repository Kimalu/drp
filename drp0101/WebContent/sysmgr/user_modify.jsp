...
<%
	String userId=request.getParameterValues("selectFlag")[0];
	User u=new User();
	UserService userService=UserService.getInstance();
	u=userService.queryById(userId);
%>
<title>修改用户</title>
...
<script type="text/javascript">
	...
	function modifyUser() {
		...
		if(c1&&c2&&c3&&c4&&c5){
			...
			userForm.action="<%=request.getContextPath()%>/sysmgr/UserController?command=update";
...
<table width="95%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td align="left" width="78%"><input name="userId" type="text" class="text1" id="userId" size="10" maxlength="10" readonly="true" value="<%=u.getUserId() %>"></input></td>
	</tr>
	<tr>
		<td height="26">
		<div align="right"><font color="#FF0000">*</font>用户名称:&nbsp;</div>
		</td>
		<td align="left"><input name="userName" type="text" class="text1" id="userName" size="20" maxlength="20" value="<%=u.getUserName() %>"></input></td>
	</tr>
	<tr>
		<td height="26">
		<div align="right"><font color="#FF0000">*</font>密码:&nbsp;</div>
		</td>
		<td align="left"><label> <input name="password" type="password" class="text1" id="password" size="20" maxlength="20" value="<%=u.getPassword() %>"></input></label></td>
	</tr>
	<tr>
		<td height="26">
		<div align="right">联系电话:&nbsp;</div>
		</td>
		<td align="left"><input name="contactTel" type="text" class="text1" id="contactTel" size="20" maxlength="20" value="<%if(u.getContactTel()==null){out.print("");}else{out.print(u.getContactTel());} %>"></input></td>
	</tr>
	<tr>
		<td height="26">
		<div align="right">email:&nbsp;</div>
		</td>
		<td align="left"><input name="email" type="text" class="text1" id="email" size="20" maxlength="20" value="<%if(u.getEmail()==null){out.print("");}else{out.print(u.getEmail());} %>"></input></td>
	</tr>
</table>
<hr width="97%" align="center" size=0>
