...
<html>
	...
	function bottomPage() {
		window.self.location = "fiscal_year_period_maint.jsp?pageNo=<%=pageModel.getButtomPageNo()%>";
	}
		</script>
	</head>
